...
const String stringBackgroundEvent =
    'Parkour Jakarta akan mengadakan kegiatan yang berbeda dengan memberikan kompetisi parkour sekaligus untuk merayakan hari jadi komunitas yang ke 15 tahun. Kegiatan yang akan dilakukan tentunya tidak akan lengkap tanpa dukungan dari berbagai pihak sehingga besar harapan kami untuk mewujudkan perayaan bersama kami ini.';
